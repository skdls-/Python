...
cursor.execute('''
    CREATE TABLE cinema (id INTEGER PRIMARY KEY, name TEXT)
''')
...
cursor.execute('''
    CREATE TABLE projections(id INTEGER PRIMARY KEY, movie_id INTEGER,
...
cursor.execute('''
    CREATE TABLE reservations(id INTEGER PRIMARY KEY, username TEXT,
